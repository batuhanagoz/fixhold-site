    ...
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <section id="about" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          {/* 4 kart: iki tanesinde gerçek görsel, diğer ikisinde yer tutucu */}
          <div className="grid sm:grid-cols-2 gap-4">
            {/* CNC İşleme Fikstürü */}
            <div className="rounded-2xl border border-neutral-200 p-5 bg-neutral-50">
              <img src="/portfolio/cnc.jpg" alt="CNC İşleme Fikstürü" className="h-28 w-full object-cover rounded-xl mb-4" />
              <div className="font-semibold text-neutral-900">CNC İşleme Fikstürü</div>
              <p className="text-sm text-neutral-600 mt-1">Konumlandırma, hızlı bağlama ve tekrarlanabilirlik.</p>
            </div>

            {/* Kaynak Fikstürü */}
            <div className="rounded-2xl border border-neutral-200 p-5 bg-neutral-50">
              <img src="/portfolio/kaynak.jpg" alt="Kaynak Fikstürü" className="h-28 w-full object-cover rounded-xl mb-4" />
              <div className="font-semibold text-neutral-900">Kaynak Fikstürü</div>
              <p className="text-sm text-neutral-600 mt-1">Isıl deformasyonu azaltan, ergonomik çözümler.</p>
            </div>

            {/* Yer tutucu 1 */}
            <div className="rounded-2xl border border-neutral-200 p-5 bg-neutral-50">
              <div className="h-28 rounded-xl bg-gradient-to-br from-neutral-100 to-neutral-200 mb-4 grid place-items-center text-neutral-400 text-sm">Görsel/Render</div>
              <div className="font-semibold text-neutral-900">Montaj Fikstürü</div>
              <p className="text-sm text-neutral-600 mt-1">İş istasyonu verimliliği ve operatör güvenliği.</p>
            </div>
            ...
            <div className="rounded-2xl border border-neutral-200 p-5 bg-neutral-50">
              ...
              <p className="text-sm text-neutral-600 mt-1">GD&T uyumlu ölçüm ve doğrulama.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="portfolio" className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-end justify-between gap-4">
          <h2 className="text-2xl sm:text-3xl font-extrabold">Portföy</h2>
        ...
        <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { img: "cnc.jpg", title: "CNC İşleme Fikstürü" },
            { img: "kaynak.jpg", title: "Kaynak Fikstürü" },
            { img: "fixture3.jpg", title: "Montaj Fikstürü" },
            { img: "fixture4.jpg", title: "Kontrol Fikstürü" },
            { img: "fixture5.jpg", title: "Özel Bağlama Çözümü" },
            { img: "fixture6.jpg", title: "Prototip Fikstür" },
          ].map((c, i)=> (
            <div key={c.img} className="group rounded-2xl overflow-hidden border border-neutral-200 bg-neutral-50">
              <img
                src={`/portfolio/${c.img}`}
                alt={c.title}
